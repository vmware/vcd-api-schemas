...
openssl aes-256-cbc -K $encrypted_c59801cc017b_key -iv $encrypted_c59801cc017b_iv -in build-resources/gpg_files.tar.enc -out build-resources/gpg_files.tar -d
